...
AccelerometerTrusted_node1714474689380 = glueContext.write_dynamic_frame.from_options(frame=DropFields_node1714538502299, connection_type="s3", format="json", connection_options={"path": "s3://btolakdend23/accelometer/trusted/", "partitionKeys": []}, transformation_ctx="AccelerometerTrusted_node1714474689380")
